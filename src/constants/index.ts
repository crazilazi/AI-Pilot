...
export const STORAGE_KEYS = {
  AGENTS: 'retain-ai-agents',           // Box for all our AI agents
  MCP_SERVERS: 'retain-ai-mcp-servers', // Box for MCP server connections
} as const;
 ...
 * 
 * Instead of writing:
 *   localStorage.getItem('retain-ai-agents')
 * 
 * Write:
